...
function tambahPegawai($data)
{
    ...
    $query = "INSERT INTO pegawai VALUE('$nip', '$nama', '$golongan', '$jabatan', '$jk', '$agama', '$tLahir', '$tglLahir', '$pendidikan', '$alamat', '$no_telp', '$email')";
...
function ubahPegawai($data)
{
    ...
    $query = "UPDATE pegawai SET nama = '$nama', golongan = '$golongan', jabatan = '$jabatan', jk = '$jk', agama = '$agama', t_lahir = '$tLahir', tgl_lahir = '$tglLahir', pendidikan = '$pendidikan', alamat = '$alamat', no_telp = '$no_telp', email = '$email' WHERE nip = '$nip'";
    mysqli_query($conn, $query);
