...
$cetakFilterPengajuanByTahunAndBulan = query("SELECT * FROM " . 'tb_uang_ganti' . " WHERE " . "tanggal_transaksi >= " . "'$dariTanggal'" . ' AND ' . "tanggal_transaksi <= " . "'$sampaiTanggal'" . ' AND ' . "status = " . "'$status'" . ' ORDER BY tanggal_transaksi DESC ' . "");
...
<body>
  <div class="container-fluid";>
    ...
    <hr>
    <h4 style="text-align: center;">Rekapitulasi pengajuan : <br>' . $dariTanggal . ' ~ ' . $sampaiTanggal . ' dengan status - ' . $status . '.</h4>';
