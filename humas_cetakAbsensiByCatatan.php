...
$cetakFilterPresensiByCatatan = query("SELECT * FROM tb_absensi WHERE catatan = '$catatan' ORDER BY tanggal_absen DESC");
...
<body>
  <div class="container-fluid";>
    ...
    <hr>
    <h3 style="text-align: center;">REKAPITULASI PRESENSI BERDASARKAN CATATAN : ' . $catatan . '</h3>';
