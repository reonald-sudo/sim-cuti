...
$cetakFilterGajiTunjangan = query("SELECT * FROM tb_tunjangan_dan_gaji_pegawai ORDER BY bulan ASC");
...
<body>
  <div class="container-fluid";>
    ...
    <hr>
    <h4 style="text-align: center;">Rekapitulasi seluruh gaji dan tunjangan</h5>';
