...
$cetakFilterPresensiByTahunAndBulan = editData("SELECT * FROM tb_uang_ganti WHERE nip = '$nipModal'");
...
<body>
  <div class="container-fluid";>
    ...
    <hr>
    <h4 style="text-align: center;">Rekapitulasi pengajuan reimbursment <br> ' . $cetakFilterPresensiByTahunAndBulan['nip'] . ' - ' . $cetakFilterPresensiByTahunAndBulan['nama'] . '</h5>';
